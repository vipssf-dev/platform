  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans" dir="rtl">
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4 flex justify-between items-center">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              <h1 className="text-base sm:text-xl font-bold text-slate-900">شؤون الطلاب</h1>
      ...
      <main className="container mx-auto px-3 sm:px-4 py-6 sm:py-8">
        ...
        >
          <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2">أنظمة شؤون الطلاب</h2>
          <p className="text-sm sm:text-base text-slate-600">النشاط والتوجيه والإشراف الصحي والحافلات</p>
        </motion.div>
